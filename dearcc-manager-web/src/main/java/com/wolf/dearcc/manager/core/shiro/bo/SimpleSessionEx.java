...
改写 SimpleSession 去掉 transient 为了能够protobuf序列化
https://blog.csdn.net/zhenxing_zr/article/details/80007865
 */

public class SimpleSessionEx implements ValidatingSession, Serializable {
    private static final long serialVersionUID = -7125642695178165650L;
    private static final  Logger log = LoggerFactory.getLogger(SimpleSessionEx.class);
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            return true;
        } else if (obj instanceof SimpleSessionEx) {
            SimpleSessionEx other = (SimpleSessionEx)obj;
    ...
    protected boolean onEquals(SimpleSessionEx ss) {
        boolean var10000;
        label65: {
            label58: {
